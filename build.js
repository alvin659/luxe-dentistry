...
<section class="hero">
  <div class="wrap">
    <div class="hero-text">
      ...
      <p class="lead">If you are looking for a <strong>dental clinic near me</strong>, you have found the best in Los Algodones. Luxe Dentistry by <strong>Dr. Jose Manuel Jimenez, DDS</strong> is a family-owned cosmetic and implant clinic in the heart of "Molar City," helping patients from across the US, Canada and Mexico smile with confidence for a fraction of home prices.</p>
      <ul class="hero-points">
        <li>${I.check}<span>25 years of experience, 15 in Los Algodones</span></li>
        <li>${I.check}<span>Save up to 70% versus US &amp; Canada prices</span></li>
        <li>${I.check}<span>Hundreds of smile makeovers performed</span></li>
        <li>${I.check}<span>Walk across the border from Yuma, Arizona</span></li>
      </ul>
...
<section class="video-strip section-alt">
  <div class="wrap video-band">
    <div class="fb-video">
    ...
    <div class="video-band-text">
      <div class="eyebrow">Inside Our Clinic</div>
      <h2>See Luxe Dentistry for Yourself</h2>
      <p class="section-intro" style="margin:0 0 22px">A quick look at our clinic and team in Los Algodones: modern, comfortable and just steps across the border from Yuma, Arizona. When you are ready, book a free consultation and we will take care of the rest.</p>
      <a class="btn btn-gold" href="/booking.html">Book a Free Consultation</a>
    </div>
  </div>
</section>
